...
description: This is my course work for Introduction to Hardware Design and Tools. Where I implemented  from single cycle, multi-cycle to pipeline processor. It's a 32 bit processor which supports the main instruction sets of RISCV, and later they are deployed to FPGA board, where I achieved communication between different components using a AXI4 bus approach.
techStack:
  - RISCV
  - FPGA
  - Verilog
